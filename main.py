...
from connect_to_db import create_tables
...
def main():
    ...
    while True:
        ...
        try:
            drivers = int(input())
            generate_drivers(
                drivers, num_of_users=num_of_app_users, num_of_licenses=num_of_licenses
            )
    ...
    while True:
        ...
        try:
            ...
            generate_tickets(
                ...
                num_of_ticket_types=num_of_ticket_types,
            )
    ...
    while True:
        ...
        try:
            ...
            generate_fines(
                fines,
                num_of_passengers=num_of_passengers,
                num_of_ticket_inspectors=num_of_ticket_inspectors,
            )
            num_of_fines = fines
            break
        except IndexError or ValueError:
    ...
    while True:
        ...
        try:
            ...
            generate_path_stops(
                path_stops, num_of_paths=num_of_paths, num_of_stops=num_of_stops
            )
    ...
    while True:
        ...
        try:
            ti = int(input())
            generate_ti(
                ti, num_of_drivers=num_of_drivers, num_of_vehicles=num_of_vehicles
            )
            num_of_ti = ti
            break
        except IndexError or ValueError:
