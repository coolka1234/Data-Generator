...
import sys
from numbers_info import num_of_lines, num_of_paths
...
def generate_path_stops(how_many):
    ...
    for _ in range(how_many):
        while True:
            ...
            if f'{id_path}-{id_stop}-{path_minute}' not in path_stops_fk_keys_set:
                path_stops_fk_keys_set.add(f'{id_path}-{id_stop}-{path_minute}')
